...
const Footer = () => {
    return (
        <footer className="bg-[#0e1b36] text-white pt-12 pb-8">
                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
                    ...
                    <div className="col-span-1 md:col-span-1">
                        ...
                        <p className="text-gray-400 text-sm leading-relaxed">
                            We provide the best real estate services to make your dream home a reality. Trust us for quality and excellence.
                        </p>
                    </div>
                    ...
                    <div>
                        ...
                        <ul className="space-y-2 text-sm text-gray-400">
                            ...
                            <li><a href="#testimonials" className="hover:text-secondary transition">Testimonials</a></li>
                    ...
                    <div>
                        ...
                        <div className="flex space-x-4">
                            <a href="#" className="bg-gray-700 p-2 rounded-full hover:bg-secondary transition">
                                <span className="sr-only">Facebook</span>
                                <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24"><path d="M18 2h-3a5 5 0 00-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 011-1h3z"></path></svg>
                            </a>
                            <a href="#" className="bg-gray-700 p-2 rounded-full hover:bg-secondary transition">
